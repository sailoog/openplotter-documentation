...
All the data generated by OpenPlotter (sensors, SDR AIS, calculations...) will be sent to *system input* (UDP localhost 10110) in the NMEA 0183 Multiplexer.

All the inputs will be available multiplexed at the *system output* (UDP localhost 10110). You have just to configure OpenCPN to listen to the *system output* (UDP localhost 10110).
