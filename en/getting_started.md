...
All the inputs will be multiplexed and available at the *system output* (UDP localhost 10110). You have just to configure OpenCPN to listen to *system output* (UDP localhost 10110) to get all the data.