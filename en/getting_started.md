...
All the data generated by OpenPlotter ([Sensors](sensors.md), [SDR AIS](sdr_ais.md), [Calculations](calculate.md)...) will be sent to *system input* (UDP localhost 10110) in the NMEA 0183 Multiplexer.

All the inputs will be available multiplexed at the *system output* (UDP localhost 10110). You have just to configure OpenCPN to listen to the *system output* (UDP localhost 10110) to get all the data.